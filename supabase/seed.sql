...
-- ============================================================
-- SESSION 5 – Découvrir l'IA (en mieux)
-- ============================================================
with s5 as (
  insert into sessions (session_number, title, block_name, objective, description, order_index, estimated_duration_minutes)
  values (6, 'ChatGPT, t''es qui toi ? 🤖', 'Bloc 2 – IA & Esprit critique',
          'Comprendre comment fonctionne ChatGPT et ce qui le rend différent des autres applis.',
          'Tu connais déjà ChatGPT — mais sais-tu vraiment comment il fonctionne ? On va aller voir sous le capot !',
          6, 35)
  returning id
)
insert into activities (session_id, title, type, duration_minutes, instructions, content, order_index, xp_reward)
...
from s5, (values
  ('Sous le capot de ChatGPT 🔧', 'card', 5,
   'Tu utilises déjà ChatGPT — maintenant découvre comment il fonctionne vraiment !',
   '{"intro":true,"cards":[{"title":"ChatGPT a lu presque tout Internet","emoji":"📖","description":"Avant de te répondre, ChatGPT a lu des milliards de textes : livres, articles, sites web… C''est comme si tu avais lu toute une bibliothèque géante avant d''arriver en classe !"},{"title":"Il prédit la suite des mots","emoji":"🔮","description":"ChatGPT ne cherche pas une réponse dans un livre. Il prédit, mot par mot, la suite la plus probable. C''est pour ça qu''il est parfois à côté — il peut se tromper !"},{"title":"Il n''a pas de mémoire entre les conversations","emoji":"🧹","description":"Si tu fermes la conversation et en ouvres une nouvelle, ChatGPT t''a oublié ! Il repart de zéro. C''est pour ça qu''on se présente à chaque fois."}]}',
   1, 10),
  ('ChatGPT vs les autres 🥊', 'quiz', 8,
   'ChatGPT, c''est pas pareil que les autres applis que tu connais. Sauras-tu faire la différence ?',
   '{"questions":[{"id":"cg1","text":"YouTube recommande une vidéo selon ce que t''as déjà regardé","emoji":"▶️","options":["Même chose que ChatGPT 🤖","Différent de ChatGPT 🔀"],"correct":1,"explanation":"YouTube utilise une IA qui observe TES habitudes. ChatGPT lui répond à des questions — c''est un usage complètement différent !"},{"id":"cg2","text":"ChatGPT peut te raconter une histoire que personne n''a jamais écrite avant","emoji":"✍️","options":["Vrai ✅","Faux ❌"],"correct":0,"explanation":"Oui ! ChatGPT génère du nouveau contenu à chaque fois. Ce n''est pas juste copier-coller depuis Internet."},{"id":"cg3","text":"Si ChatGPT dit quelque chose, c''est forcément vrai","emoji":"🤔","options":["Vrai ✅","Faux ❌"],"correct":1,"explanation":"Faux ! ChatGPT peut inventer des choses qui semblent vraies mais qui sont fausses. On appelle ça des hallucinations. Toujours vérifier !"},{"id":"cg4","text":"ChatGPT comprend le message vocal si tu dicter à l''iPhone","emoji":"🎙️","options":["Vrai ✅","Faux ❌"],"correct":0,"explanation":"Oui ! Tu peux dicter avec le micro de ton téléphone ou tablette et ChatGPT comprend très bien. Super pratique !"},{"id":"cg5","text":"ChatGPT se souvient de ta conversation de la semaine dernière","emoji":"📅","options":["Vrai ✅","Faux ❌"],"correct":1,"explanation":"Faux ! Sans mémoire activée, chaque nouvelle conversation repart de zéro. C''est pour ça qu''il faut se présenter au début."}]}',
   2, 25),
  ('Trie les super-pouvoirs de l''IA ! 💪', 'drag_drop', 7,
   'Glisse chaque capacité dans la bonne case : ChatGPT SAIT faire ✅ ou ChatGPT NE SAIT PAS faire ❌',
   '{"categories":[{"id":"can","label":"ChatGPT SAIT faire ✅","color":"green"},{"id":"cannot","label":"ChatGPT NE SAIT PAS faire ❌","color":"red"}],"items":[{"id":"i1","label":"Écrire une histoire rigolote","category":"can","emoji":"✍️"},{"id":"i2","label":"Sentir si ta pizza est brûlée","category":"cannot","emoji":"🍕"},{"id":"i3","label":"Traduire en 50 langues","category":"can","emoji":"🌍"},{"id":"i4","label":"Être vraiment de bonne humeur","category":"cannot","emoji":"😄"},{"id":"i5","label":"Expliquer une leçon difficile","category":"can","emoji":"📚"},{"id":"i6","label":"Te faire un câlin quand tu es triste","category":"cannot","emoji":"🤗"},{"id":"i7","label":"Corriger tes fautes d''orthographe","category":"can","emoji":"✏️"},{"id":"i8","label":"Savoir ce qui se passe aujourd''hui","category":"cannot","emoji":"📰"}],"shuffle":true,"tip":"Rappelle-toi : ChatGPT peut se tromper, il n''a pas de corps, et il oublie les nouvelles récentes !"}',
   3, 25),
  ('Dis-lui ce que tu aimes ! 🎯', 'editor', 8,
   'Pour que ChatGPT te réponde mieux, présente-toi ! Tu peux dicter à voix haute ou écrire — les fautes d''orthographe ne comptent pas, ChatGPT comprend quand même 😊',
   '{"voice_enabled":true,"spelling_tolerance":true,"voice_tip":"Appuie sur le micro 🎙️ de ton clavier pour parler au lieu d''écrire !","spelling_note":"Pas de stress si tu fais des fautes — ChatGPT comprend très bien !","tasks":[{"id":"t1","emoji":"🙋","label":"Présente-toi à ChatGPT","placeholder":"Je m''appelle... j''ai ... ans, je suis en ...","starter":"Je m''appelle","min_length":5},{"id":"t2","emoji":"❤️","label":"Dis-lui ce que tu adores","placeholder":"J''adore... comme sujet, j''aime aussi...","starter":"J''adore","min_length":5}],"tip":"Ces 2 phrases, tu peux les coller au début de chaque conversation ChatGPT pour des réponses sur-mesure !"}',
   4, 20),
  ('Exercice clavier', 'typing', 5,
   'Tape cette phrase pour terminer la séance !',
   '{"text":"ChatGPT peut se tromper, alors je vérifie toujours.","target_wpm":18,"show_timer":false}',
   5, 15)
) as act(title, type, dur, instr, content, ord, xp)
on conflict do nothing;
...
with s6 as (
  insert into sessions (session_number, title, block_name, objective, description, order_index, estimated_duration_minutes)
  values (7, 'Parle à ChatGPT comme un pro ! 🎯', 'Bloc 2 – IA & Esprit critique',
          'Apprendre à formuler des questions claires pour obtenir les meilleures réponses.',
          'Une bonne question = une super réponse ! Apprends le secret des meilleurs utilisateurs de ChatGPT.',
          7, 40)
  returning id
)
insert into activities (session_id, title, type, duration_minutes, instructions, content, order_index, xp_reward)
